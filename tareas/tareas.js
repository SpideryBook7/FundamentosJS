    ...
    if (e.target.classList.contains('btn')) {
        ...
        switch (action) {
            case 'red':
                ...
                tareaActual.classList.add('alert', 'aler-danger');
                break;
            case 'yellow':
                tareaActual.classList = [];
                tareaActual.classList.add('alert', 'aler-warning');
                break;
            case 'green':
                tareaActual.classList = [];
                tareaActual.classList.add('alert', 'aler-success');
                break;
            case 'x':
                tareaActual.remove();
                break;
